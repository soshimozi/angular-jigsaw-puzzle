...
function JigsawPuzzleFactory() {
    
    function JigsawPuzzle(options) {
    ...
    JigsawPuzzle.prototype.setImage = function(image) {
        this.image = image;
        
        console.log('image: ', image);
    };
    
    JigsawPuzzle.prototype.cut = function() {
        console.log('cut');
    };
    
    
    return function(options) {
        return new JigsawPuzzle(options);
    };
}


JigsawPuzzleFactory.$inject = [];

module.exports = JigsawPuzzleFactory;